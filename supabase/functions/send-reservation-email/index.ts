    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#FDFBF7;border:1px solid rgba(43,24,16,0.08);border-radius:4px;">
        ...
        <tr><td style="padding:0 40px 28px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(43,24,16,0.025);border:1px solid rgba(43,24,16,0.06);border-radius:4px;padding:20px;">
            <tr><td>
              ...
              <p style="margin:0 0 8px;font-size:14px;color:#3A332E;line-height:1.6;">2. Envia el comprobante por WhatsApp al <strong>301 506 2669</strong></p>
        ...
        <tr><td style="padding:24px 40px;border-top:1px solid rgba(43,24,16,0.08);text-align:center;">
          ...
          <p style="margin:4px 0 0;font-size:12px;color:#8B8680;">+57 301 506 2669 &middot; @marytierrarestaurantbga</p>
        </td></tr>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#FDFBF7;border:1px solid rgba(43,24,16,0.08);border-radius:4px;">
        ...
        <tr><td style="padding:28px 40px;">
          ...
          <div style="background:rgba(43,24,16,0.025);border:1px solid rgba(43,24,16,0.06);border-radius:4px;padding:20px;margin-bottom:20px;">
            ...
            <p style="margin:0;font-size:13px;font-style:italic;color:#8B8680;">Envia el comprobante por WhatsApp al 301 506 2669</p>
          </div>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#FDFBF7;border:1px solid rgba(43,24,16,0.08);border-radius:4px;">
        ...
        <tr><td style="padding:24px 40px;border-top:1px solid rgba(43,24,16,0.08);text-align:center;">
          ...
          <p style="margin:0;font-size:12px;color:#8B8680;">+57 301 506 2669 &middot; Cra 35a #46-102, Bucaramanga</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
